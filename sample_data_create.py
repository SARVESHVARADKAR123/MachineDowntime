...
# Apply downtime rule: Downtime_Flag is "Yes" if Temperature > 85 or Run_Time > 130
data["Downtime_Flag"] = [
    "Yes" if temp > 85 or runtime > 130 else "No"
...
outliers = pd.DataFrame({
    ...
    "Downtime_Flag": ["Yes"] * 10,  # All outliers lead to downtime
})
